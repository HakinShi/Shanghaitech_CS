...
import random
import util
from layout import PROB_BOTH_TOP, PROB_BOTH_BOTTOM, PROB_ONLY_LEFT_TOP,PROB_ONLY_LEFT_BOTTOM, PROB_FOOD_RED, PROB_GHOST_RED
...
def fillObsCPT(bayesNet, gameState):
   ...
   assignment[FOOD_HOUSE_VAR]   =   topLeft
    ...
    bayesNet.variableDomainsDict() is 
   {'obs(4,4)': ['blue', 'red', 'none'], 'obs(2,3)': ['blue', 'red', 'none'], 'obs(4,3)': ['blue', 'red', 'none'], 'obs(2,2)': ['blue', 'red', 'none']}
    '''
    dic = {}
   ...
   # print('vdd is :', bayesNet.variableDomainsDict())

...
def inferenceByVariableEliminationWithCallTracking(callTrackingList=None):
    ...
    def inferenceByVariableElimination(bayesNet, queryVariables, evidenceDict, eliminationOrder):
        ...
        "*** YOUR CODE HERE ***"
        ''' 
        print('evidencedict is: ', evidenceDict)
        print('tables are : ', tables)
        
        evidencedict is:  {'W': 'sun'}
        tables are :  [Factor({'W'}, set(), {'W': ['sun'], 'D': ['dry', 'wet'], 'T': ['hot', 'cold']}), Factor({'T'}, {'W'}, {'W': ['sun'], 'D': ['dry', 'wet'], 'T': ['hot', 'cold']}),
         Factor({'D'}, {'W'}, {'W': ['sun'], 'D': ['dry', 'wet'], 'T': ['hot', 'cold']})]
        
        
        print('query var is: ', queryVariables)
        print('elimination order is: ', eliminationOrder)
        query var is:  ['D']
        elimination order is:  ['T']
        '''
